{% extends 'layout.tpl' %} {% block favicon
%}/lib/img/aps/blog/icon.png{% endblock favicon %} {% block meta_title
%}Search{% endblock meta_title %} {% block meta_description %}A simple
blogging application{% endblock meta_description %} {% block js %}
...
{% endblock %} {% block main %}
<div
    class="row clearfix transparentBlackBg rounded well ui-transition ui-shadow">
                        ...
                        <div class="container-fluid">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="#"
                                    ...
                                    data-selector="#dashboard"
                                    role="button"
                                    title="Gérer les posts"> <span
                                        class="glyphicon glyphicon-globe"></span>
                                        <strong>Posts</strong>
                                </a></li>
                                <li><a href="#"><span
                                        class="glyphicon glyphicon-comment"></span>
                                        <strong>Comments</strong></a></li>
                            </ul>
