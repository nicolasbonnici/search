...
{% block main %}
    ...
    <div class="row clearfix transparentBlackBg rounded well ui-transition ui-shadow">
        <div class="col-md-2 column">
            <img src="/lib/bundles/search/icon.png" alt="App icon" />
        </div>
                        ...
                        <nav class="col-md-12 navbar navbar-inverse navbar-default" role="navigation">
                          <div class="container-fluid">
                                <ul class="nav navbar-nav">
                                  <li class="active">
                                    <a href="#" class="ui-sendxhr" data-url="/search/dashboard/" data-selector="#dashboard" role="button">
                                        <span class="glyphicon glyphicon-home"></span> <strong>Dashboard</strong>
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#" class="ui-sendxhr refreshOnCallback" data-url="/search/posts/" data-selector="#dashboard" role="button" title="Gérer les posts">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                  <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="#" type="button" class="ui-sendxhr" data-url="/search/posts/create/" data-selector="#modal-post-content" role="button" data-toggle="modal">
                                                <span class="glyphicon glyphicon-file"></span> Bla bla
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" type="button" class="ui-sendxhr" data-url="/search/posts/" data-selector="#dashboard" role="button">
